...
import IconsNetwork from '@/components/icons/network'
      ...
      <section>
        <article className="bg-black w-[35%] relative p-3">
          <article className="text-white">
            ...
            <p className="font-[500] text-[18px] pb-[10%]">Say something start a live chat!</p>
          ...
          <div className="absolute z-5 bottom-10">
            <IconsNetwork styleicons="text-white" colorfacebook="" bgfacebook="bg-withe" />
          </div>
        </article>
      </section>
    </>
